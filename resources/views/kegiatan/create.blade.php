        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="date" name="tgl_mulai" class="form-control" placeholder="Tanggal Mulai" value="{{ old('tgl_mulai') }}">
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="date" name="tgl_selesai" class="form-control" placeholder="Tanggal Selesai" value="{{ old('tgl_selesai') }}">
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="thn_akademik" class="form-control" placeholder="Tahun Akademik" value="{{ old('thn_akademik') }}">
                </div>
            </div>
